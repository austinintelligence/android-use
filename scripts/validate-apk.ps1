param(
  [string]$Apk = (Join-Path $PSScriptRoot 'helper\app\build\outputs\apk\release\app-release.apk'),
...
Add-Check 'compile-sdk-source' ((Get-Content -Raw (Join-Path $PSScriptRoot 'helper\app\build.gradle')) -match 'compileSdk\s*=\s*36') 'build.gradle compileSdk 36'
