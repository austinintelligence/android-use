...
These commands become available after the release owner publishes the package
to npm. Until then, install the skill from GitHub or run this package from the
repository checkout; the GitHub prerelease assets are already hash-pinned.
